...
export const login = (email: string, password: string) => authServiceInstance.login(email, password);
export const register = (email: string, password: string, name?: string) => authServiceInstance.register(email, password, name);
